...
private val panduanPenggunaanList =
    mapOf(
        ...
        "https://tugas-akhir.portfoliobypgh.my.id/image/2b.png" to "Pada halaman perbandingan prediksi, fitur ini bertujuan untuk menampilkan grafik prediksi harga penutupan saham tersebut. Opsi di bawah bertujuan untuk menampilkan hasil prediksi berdasarkan algoritma LSTM atau GRU.",
        "https://tugas-akhir.portfoliobypgh.my.id/image/2c.png" to "Pada halaman perbandingan prediksi, fitur ini bertujuan untuk menampilkan grafik histori harga penutupan saham tersebut. Opsi di bawah bertujuan untuk menampilkan durasi grafik.",
        "https://tugas-akhir.portfoliobypgh.my.id/image/2d.png" to "Pada halaman perbandingan prediksi, fitur ini bertujuan untuk menampilkan profil informasi saham bank digital tersebut yang terdiri dari gambar ikon, nama perusahaan, ringkasan, dan sebagainya.",
